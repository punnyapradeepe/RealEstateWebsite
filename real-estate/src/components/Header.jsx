...
const Header = () => {
  return (
    ...
    <Navbar/>
    <div className='container text-center mx-auto  text-white py-4 px-6 md:px-20 lg:px-32 mt-20'>
        <h2 className='text-5xl sm:text-6xl md:text-[82px] inline-block max-w-3xl font-semibold pt-5'>Explore homes that fit your dreams</h2>
